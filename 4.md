...
<img src="study/4-1.png" alt="구조완성" height="400">

이제 레이아웃을 잡아보자.
일단 post-comment-like부터 잡으면 이렇다.
...
<img src="study/4-2.png" alt="like complete" height="400">

다음은 post-comment-list로 넘어가자.
- 포지션에 대한 좀더 자세한 자료
  - https://developer.mozilla.org/ko/docs/Web/CSS/All_About_The_Containing_Block#%EC%BB%A8%ED%85%8C%EC%9D%B4%EB%8B%9D_%EB%B8%94%EB%A1%9D_%EC%8B%9D%EB%B3%84
...
원래 있던 색상을 지우면 아래와 같이 완성될 것이다.
그럼 일단 기본적인 포스트 레이아웃은 완성이다.

<img src="study/4-3.png" alt="인스타 완성" height="400">